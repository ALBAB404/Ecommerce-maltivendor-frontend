  ...
  <div>
    ...
    <aside class="nav-sidebar">
      <div class="nav-header">
        <a href="#"><img src="./assets/@/assets/images/logo.png" alt="logo" /></a><button class="nav-close"><i
              ...
              <div class="col-md-6 col-lg-6">
                <div class="view-gallery">
                  ...
                  <ul class="preview-slider slider-arrow">
                    <li><img src="./assets/@/assets/images/product/01.jpg" alt="product" /></li>
                    <li><img src="./assets/@/assets/images/product/01.jpg" alt="product" /></li>
                    <li><img src="./assets/@/assets/images/product/01.jpg" alt="product" /></li>
                    <li><img src="./assets/@/assets/images/product/01.jpg" alt="product" /></li>
                    <li><img src="./assets/@/assets/images/product/01.jpg" alt="product" /></li>
        ...
        <div class="row">
          <div class="col-sm-6 col-xl-3">
            <div class="footer-widget">
              <a class="footer-logo" href="#"><img src="./assets/@/assets/images/logo.png" alt="logo" /></a>
              <p class="footer-desc">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="footer-widget">
              ...
              <div class="footer-app">
                <a href="#"><img src="./assets/@/assets/images/google-store.png" alt="google" /></a><a href="#"><img
                    src="./assets/@/assets/images/app-store.png" alt="app" /></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="footer-bottom">
              ...
              <div class="footer-card">
                <a href="#"><img src="./assets/@/assets/images/payment/jpg/01.jpg" alt="payment" /></a><a href="#"><img
                    src="./assets/@/assets/images/payment/jpg/02.jpg" alt="payment" /></a><a href="#"><img src="./assets/@/assets/images/payment/jpg/03.jpg"
                    alt="payment" /></a><a href="#"><img src="./assets/@/assets/images/payment/jpg/04.jpg" alt="payment" /></a>
              </div>
            </div>
          </div>
        </div>
