              ...
              <div class="row">
                ...
                <div class="col-md-7 col-lg-4">
                  <ul class="header-top-list">
                    <li><router-link :to="{ name: 'seller.apply' }" href="offer.html">Seller Apply</router-link>
                    </li>
                ...
                <div class="header-widget-group hover-nav">
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <li>
                        <router-link :to="{ name: 'user.orders' }" class="dropdown-item" >My Orders</router-link> </li>
